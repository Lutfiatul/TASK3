...
const int okLED = 8;               // LED for checking the battery
const int warningLED = 10;         // LED for checking the battery
...
int analogValue = 0;               // Measuring the voltage which enter the pin analog 2 (when the battery is not connected)
float voltage = 0;                 // The value of the voltage
